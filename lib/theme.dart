...
class AppColor{
  static const Color PrimaryColor = Color(0xFFF9E9C8);
  static const Color PrimaryColor2 = Color(0xFFDEECED);
  static const Color PrimaryColor3 = Color(0xFFEDDAB3);
  static const Color PrimaryColor4 = Color(0xFFDED3FD);
}
